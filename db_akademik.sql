...
-- Dumping data for table db_akademik.galeri: ~1 rows (approximately)
...
-- Dumping data for table db_akademik.link: ~0 rows (approximately)
...
-- Dumping data for table db_akademik.log_histori: ~81 rows (approximately)
