    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                ...
                <!-- /.card-header -->
                <div class="card-body">
                    <a href="#" class="btn btn-primary mb-3" data-toggle="modal" data-target="#modal-hitung"><i
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="#" class="btn btn-sm btn-warning btn-edit" data-toggle="modal"
                                            data-target="#modal-hitung-edit" data-id="{{ $p->id }}"
                                            style="color: black">
                        ...
                        <form id="form-hitung" action="" method="POST">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group" id="nama_hitung_container">
                                    ...
                                    <input type="text" class="form-control phone-inputmask" name="nama_hitung"
                                        id="nama_hitung" placeholder="Masukkan Nama Hitung">
                                </div>
                                <div class="form-group" id="jumlah_container">
                                    <label for="jumlah">Jumlah Hitung</label>
                                    <input type="number" class="form-control phone-inputmask" name="jumlah" id="jumlah"
                                        placeholder="Masukkan Jumlah Hitung">
                                </div>
                                <div class="form-group" id="hitung_container">
                                    <label for="hitung">Hitung</label>
                                    <input type="text" class="form-control phone-inputmask" name="hitung" id="hitung"
                                        placeholder="Masukkan Hitung">
                                </div>
                                <div class="form-group" id="urutan_container">
                                    <label for="urutan">Urutan</label>
                                    <input type="text" class="form-control phone-inputmask" name="urutan" id="urutan"
                            ...
                            <div class="card-footer">
                                <button type="submit" class="btn btn-primary" id="btn-save-hitung"><i
                        ...
                        <form id="form-hitung-edit" action="" method="POST">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group" id="nama_hitung_edit_container">
                                    ...
                                    <input type="text" class="form-control phone-inputmask" name="nama_hitung"
                                        id="nama_hitung_edit" placeholder="Masukkan Nama Hitung">
                                </div>
                                <div class="form-group" id="jumlah_edit_container">
                                    <label for="jumlah_edit">Jumlah Hitung</label>
                                    <input type="number" class="form-control phone-inputmask" name="jumlah"
                                        id="jumlah_edit" placeholder="Masukkan Jumlah Hitung">
                                </div>
                                <div class="form-group" id="hitung_edit_container">
                                    <label for="hitung_edit">Hitung</label>
                                    <input type="text" class="form-control phone-inputmask" name="hitung"
                                        id="hitung_edit" placeholder="Masukkan Hitung">
                                </div>
                            ...
                            <div class="card-footer">
                                <button type="submit" class="btn btn-primary" id="btn-update-hitung"><i
                                        class="fas fa-save"></i> Simpan</button>
                                <button type="button" class="btn btn-danger float-right" data-dismiss="modal"><span
                                        aria-hidden="true">&times;</span> Close</button>
                            </div>
