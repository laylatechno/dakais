                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('guru.update', $data->id) }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control honor" name="honor" placeholder="Masukan Honor"
                                value="{{ number_format($data->honor) }}">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" name="status">
                                ...
                                <option value="Non Guru"
                                    {{ old('status', $data->status) == 'Non Guru' ? 'selected' : '' }}>
                                    Non Guru
                                </option>
                            </select>
                        </div>
                        ...
                        @enderror
                        <div class="form-group">
                            <label>Posisi <small class="text-muted">(Cth : Guru IPA)</small></label>
                            <input type="text" class="form-control phone-inputmask" name="posisi"
                                placeholder="Masukan Posisi Guru" value="{{ $data->posisi }}">
                        </div>
                        ...
                        @enderror
                        <div class="form-group">
                            <label>Motto <small class="text-muted">(Cth : Guru Do Teh Best)</small></label>
                            <input type="text" class="form-control phone-inputmask" name="motto"
                                placeholder="Masukan Motto Guru" value="{{ $data->motto }}">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" name="status_aktif">
                                ...
                                <option value="Aktif"
                                    {{ old('status_aktif', $data->status_aktif) == 'Aktif' ? 'selected' : '' }}>
                                    Aktif
                                </option>
                                <option value="Non Aktif"
                                    {{ old('status_aktif', $data->status_aktif) == 'Non Aktif' ? 'selected' : '' }}>
                                    Non Aktif
                                </option>
                            </select>
                        </div>
                        ...
                        <div class="form-group">
                            <a href="/upload/guru/{{ $data->gambar }}" target="_blank">
                                <img style="max-width:50px; max-height:50px" src="/upload/guru/{{ $data->gambar }}"
                                    alt="">
                            </a>
                        </div>
                        ...
                        <div class="border-top">
                            <div class="card-body">
                                ...
                                <a href="/guru" class="btn btn-danger" style="color:white;"><i
