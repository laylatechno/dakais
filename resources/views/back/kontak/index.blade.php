...
@section('title','Halaman Lihat Kontak')
@section('subtitle','Menu Lihat Kontak')
    ...
    <div class="col-12">
      <div class="card">
        <div class="card-header">
          <h3 class="card-title">Data Lihat Kontak - {{ $profil->nama_sekolah }}</h3>
        </div>
          <!-- /.card-header -->
          <div class="card-body">
