...
@section('title', 'Halaman Satuan Produk')
@section('subtitle', 'Menu Satuan Produk')
...
@section('content')
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Data Satuan Produk - {{ $profil->nama_sekolah }}</h3>
                </div>
                <!-- /.card-header -->
                <div class="card-body">
                    <a href="#" class="btn btn-primary mb-3" data-toggle="modal" data-target="#modal-satuan_produk"><i
                    ...
                    <table id="example1" class="table table-bordered table-striped">
                        ...
                        <tbody>
                            ...
                            @foreach ($satuan_produk as $p)
                                <tr>
                                    <td>{{ $loop->iteration }}</td>
                                    <td>{{ $p->nama_satuan_produk }}</td>
                                    <td>{{ $p->urutan }}</td>
                                    <td>
                                        <a href="#" class="btn btn-sm btn-warning btn-edit" data-toggle="modal"
                                            data-target="#modal-satuan_produk-edit" data-id="{{ $p->id }}"
                                            style="color: black">
    ...
    {{-- Modal Tambah Data --}}
    <div class="modal fade" id="modal-satuan_produk">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title">Form Satuan Produk</h4>
                ...
                <div class="modal-body">
                    ...
                    <div class="card card-primary">
                        ...
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form id="form-satuan_produk" action="" method="POST">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group" id="nama_satuan_produk_container">
                                    <label for="nama_satuan_produk">Nama Satuan Produk</label>
                                    <input type="text" class="form-control phone-inputmask" name="nama_satuan_produk"
                                        id="nama_satuan_produk" placeholder="Masukkan Nama Satuan Produk">
                                </div>
                            ...
                            <div class="card-footer">
                                <button type="submit" class="btn btn-primary" id="btn-save-satuan_produk"><i
    ...
    {{-- Modal Edit Data --}}
    <div class="modal fade" id="modal-satuan_produk-edit">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title">Form Satuan Produk</h4>
                ...
                <div class="modal-body">
                    ...
                    <div class="card card-primary">
                        ...
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form id="form-satuan_produk-edit" action="" method="POST">
                            @method('PUT')
                            @csrf
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group" id="nama_satuan_produk_edit_container">
                                    <label for="nama_satuan_produk_edit">Nama Satuan Produk</label>
                                    <input type="text" class="form-control phone-inputmask" name="nama_satuan_produk"
                                        id="nama_satuan_produk_edit" placeholder="Masukkan Nama Satuan Produk">
                                </div>
                            ...
                            <div class="card-footer">
                                <button type="submit" class="btn btn-primary" id="btn-update-satuan_produk"><i
                                        class="fas fa-save"></i> Simpan</button>
                                <button type="button" class="btn btn-danger float-right" data-dismiss="modal"><span
                                        aria-hidden="true">&times;</span> Close</button>
                            </div>
...
@push('scripts')
    ...
    <script>
        $(document).ready(function() {
            $('#form-satuan_produk').submit(function(event) {
                event.preventDefault();
                const tombolSimpan = $('#btn-save-satuan_produk')

                var formData = $(this).serialize();

                $.ajax({
                    url: '{{ route('satuan_produk.store') }}',
                    type: 'POST',
                    data: formData,
                    beforeSend: function() {
                    ...
                    success: function(response) {
                        $('#modal-satuan_produk').modal('hide');
                        Swal.fire({
                            title: 'Sukses!',
    ...
    <script>
        $(document).ready(function() {
            $('#btn-update-satuan_produk').click(function(e) {
                e.preventDefault();
                const tombolUpdate = $('#btn-update-satuan_produk')
                var id = $('#id').val(); // Ambil ID kota dari input tersembunyi
                var formData = new FormData($('#form-satuan_produk-edit')[0]);

                // Validasi sebelum pengiriman
                var namaSatuan = $('#nama_satuan_produk_edit').val();
                var urutan = $('#urutan_edit').val();

                // Check apakah ada data kosong sebelum pengiriman
                if (namaSatuan .trim() === '' || urutan.trim() === '') {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        $('#modal-satuan_produk-edit').modal('hide');
