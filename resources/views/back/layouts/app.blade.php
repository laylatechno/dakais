                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                        <a href="#" class="dropdown-item">
                            <!-- Message Start -->
                            <div class="media">
                                <img src="{{ asset('themplete/back') }}/dist/img/avatar.jpg" alt="User Avatar"
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <div class="sidebar">
                ...
                <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                    <div class="image">
                        <img src="{{ asset('themplete/back') }}/dist/img/avatar.jpg" class="img-circle elevation-2"
                            alt="User Image">
                    </div>
                    <div class="info">
...
<script src="{{ asset('themplete/back')}}/plugins/jqvmap/maps/jquery.vmap.usa.js"></script> --}}
    ...
    <!-- Tempusdominus Bootstrap 4 -->
    <script src="{{ asset('themplete/back') }}/plugins/tempusdominus-bootstrap-4/js/tempusdominus-bootstrap-4.min.js">
    </script>
    <!-- Summernote -->
