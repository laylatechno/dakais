            ...
            <div class="card-body">
                ...
                <form action="{{ route('portofolio.update', $data->id) }}"  method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control phone-inputmask" name="nama"
                            placeholder="Masukan Nama Portofolio" value="{{ $data->nama }}">
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control phone-inputmask" name="link"
                            placeholder="Masukan Link Portofolio" value="{{ $data->link }}">
                    </div>
                    ...
                    @enderror
                    <div class="form-group">
                        <label>Harga <small class="text-muted">(Cth : 90000.)</small></label>
                        <input type="number" class="form-control phone-inputmask" name="harga"
                            placeholder="Masukan Harga Portofolio" value="{{ $data->harga }}">
                    </div>
                ...
                <div class="border-top">
                    <div class="card-body">
                        ...
                        <a href="/portofolio" class="btn btn-danger" style="color:white;"><i class="fas fa-step-backward"></i> Kembali</a>
                    </div>
                </div>
            </form>
            </div>
