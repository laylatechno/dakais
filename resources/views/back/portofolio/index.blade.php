        ...
        <div class="card">
            <div class="card-body">
                <div class="table-responsive">
                    <a href="/portofolio/create" class="btn btn-primary mb-3"><i class="fas fa-plus-circle"></i> Tambah Data</a>
                        ...
                        <tbody>
                            <?php $i = 1; ?>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('portofolio.edit',$p->id)}}" class="btn btn-sm btn-warning" style="color: black"><i class="fas fa-edit"></i> Edit</a>
                                        <form onsubmit="return confirm('Yakin mau hapus data?')" action="{{ route('portofolio.destroy',$p->id)}}" class="d-inline" method="POST">
                                            @csrf
                                            @method('DELETE')
