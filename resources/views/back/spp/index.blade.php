    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                ...
                <!-- /.card-header -->
                <div class="card-body">
                    <a href="#" class="btn btn-primary mb-3" data-toggle="modal" data-target="#modal-spp"><i
                    ...
                    <div class="card card-primary">
                        ...
                        <form id="form-jenis-ujian" action="" method="POST">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group" id="tahun_ajaran_container">
                                    ...
                                    <select class="form-control" name="tahun_ajaran_id" id="tahun_ajaran_id">
                                        ...
                                        @foreach ($tahunAjaran as $p)
                                            <option value="{{ $p->id }}"
                                                {{ old('tahun_ajaran_id') == $p->id ? 'selected' : '' }}>
                                                {{ $p->nama_tahun_ajaran }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                <div class="form-group" id="jumlah_spp_container">
                                    <label for="jumlah_spp">Jumlah SPP</label>
                                    <input type="text" class="form-control spp" name="jumlah_spp" id="jumlah_spp"
                                ...
                                <div class="form-group" id="bulan_container">
                            ...
                            <div class="card-footer">
                                <button type="submit" class="btn btn-primary" id="btn-save-spp"><i
                                        class="fas fa-save"></i>
                                    Simpan</button>
                        ...
                        <form id="form-jenis-ujian-edit" action="" method="POST">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group" id="jumlah_spp_edit_container">
                                    ...
                                    <input type="text" class="form-control spp_edit" name="jumlah_spp"
                                        id="jumlah_spp_edit" placeholder="Masukkan Jumlah SPP">
                                </div>
                                <script src="https://code.jquery.com/jquery-3.6.0.min.js"></script>
                                ...
                                <div class="form-group" id="tanggal_jatuh_tempo_edit_container">
                                    ...
                                    <select class="form-control" name="tanggal_jatuh_tempo"
                                        id="tanggal_jatuh_tempo_edit">
                                    </select>
                                </div>
                                <script>
                                    const tanggalJatuhTempoDropdownEdit = document.getElementById('tanggal_jatuh_tempo_edit');

                                    for (let i = 1; i <= 31; i++) {
                                        const option = document.createElement('option');
                                        option.value = i.toString().padStart(2, '0');
                                        option.text = i;
                                        tanggalJatuhTempoDropdownEdit.appendChild(option);
                                    }
                                </script>

                                <div class="form-group" id="bulan_edit_container">
                                ...
                                <div class="form-group" id="tahun_edit_container">
            ...
            // $('.btn-edit').click(function(e) {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        var formattedSpp = addThousandSeparator(data
                            .jumlah_spp); // Format jumlah_spp
