    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                ...
                <!-- /.card-header -->
                <div class="card-body">
                    <a href="#" class="btn btn-primary mb-3" data-toggle="modal" data-target="#modal-berita"><i
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="card card-primary">
                        ...
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form id="form_berita" action="{{ route('simpan_berita') }}" method="POST"
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control select2" name="kategori_berita_id" id="kategori_berita_id">
                                        @foreach ($kategoriBerita as $kategori)
                                            <option value="{{ $kategori->id }}">{{ $kategori->nama_kategori_berita }}
                                            </option>
                                        @endforeach
                                    </select>
                                </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="judul_berita_edit"
                                        name="judul_berita" placeholder="Masukkan Judul Berita" required>
                                </div>
                                <div class="form-group">
                                    <label>Slug</label>
                      ...
                      <input type="text" id="isi2">
                                ...
                                <div class="form-group">
                                    ...
                                    <a id="link-gambar" href="#" target="_blank">
                                        <img id="gambar-berita" style="max-width:100px; max-height:100px" src="#"
                                            alt="Gambar">
                                    </a>
                                </div>
                                <div class="form-group">
                            ...
                            <div class="card-footer">
                                <button type="submit" class="btn btn-primary" id="btn_update_berita"><i
...
<script src="{{ asset('template') }}/plugins/jquery-ui/jquery-ui.min.js"></script> --}}
    ...
    <script>
        document.getElementById('form_berita').addEventListener('submit', function(e) {
            ...
            if (!tanggal_posting || !judul_berita || !slug || !penulis || !kategori_berita_id || !ringkasan || !
                isi || !sumber || !urutan || !status || !gambar) {
                Swal.fire({
                    icon: 'error',
                    title: 'Oops...',
                ...
                success: function(response) {
                    ...
                    Swal.fire({
                        ...
                        if (result.isConfirmed || result.isDismissed) {
                            ...
                            $('#modal-berita').modal(
                            'hide'); // Tutup modal setelah simpan berhasil
                        }
                    });
                },
